                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        {!! Form::open(array('route' => 'post.store',  'files' => true) ) !!}
                            ...
                            <div class="form-group">
                                <label>Title</label>
                                {!!Form::text('title', '',array('class' => 'form-control','placeholder' =>  'Title goes here ....'))!!}
                            </div>

                            <div class="form-group">
                                <label>Lost/Found Place</label>
                                {!!Form::text('lost_place', '',array('class' => 'form-control','placeholder' =>  'Lost/Found Place ....'))!!}
                            </div>
                            <div class="form-group">
                                <label>Lost/Found Date</label>
                                {!!Form::text('lost_date', '',array('class' => 'form-control','id'=>'datepicker','placeholder' =>  'Lost/Found Date...'))!!}
                            </div>


                            <div class="form-group">
                                <label>Lost/Found Time</label>
                                {!!Form::text('lost_time', '',array('class' => 'form-control','id'=>'timepicker3','placeholder' =>  'Lost/Found Time...'))!!}
                            </div>

                            <div class="form-group">
                                <label>Description</label>
                                {!!Form::textarea('description', '',array('class' => 'form-control','placeholder' =>  'Description goes here .....'))!!}
                            </div>
